...
$body = '
First Name: '.$first_name.'  '.PHP_EQL.'
Last Name: '.$last_name.'  '.PHP_EQL.'
email: '.$email.'  '.PHP_EQL.'
Gender: '.$gender.'  '.PHP_EQL.'
Phone: '.$phone.'  '.PHP_EQL.'
Regions: '.$regions.'  '.PHP_EQL.'
Wines: '.my_wines($wines).'  '.PHP_EQL.'
Comments: '.$comments.'  '.PHP_EQL.'
';
